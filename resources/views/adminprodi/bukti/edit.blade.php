...
@section('page_subtitle', 'Perbarui klasifikasi dokumen bukti pengisian IKU/IKT')

@section('content')
<div class="card" style="max-width: 600px; margin: 0 auto;">
    <h3 style="font-size: 1.2rem; font-weight: 700; margin-bottom: 20px; border-bottom: 1px solid #1e293b; padding-bottom: 12px;">Form Edit Jenis Bukti IKU/IKT</h3>
