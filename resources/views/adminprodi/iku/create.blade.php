...
@section('title', 'Tambah Data IKU - Admin Prodi')
@section('page_title', 'Tambah Data IKU')
@section('page_subtitle', 'Masukkan indikator kinerja utama baru ke dalam sistem')

@section('content')
<div class="card" style="max-width: 600px; margin: 0 auto;">
    <h3 style="font-size: 1.2rem; font-weight: 700; margin-bottom: 20px; border-bottom: 1px solid #1e293b; padding-bottom: 12px;">Form Tambah Data IKU</h3>
    ...
    <form action="{{ route('adminprodi.iku.store') }}" method="POST" class="form-layout-container">
        ...
        <div class="form-footer-actions">
            ...
            <button type="submit" class="btn btn-primary">Simpan IKU</button>
        </div>
    </form>
</div>
@endsection
