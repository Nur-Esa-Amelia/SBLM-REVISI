...
@section('title', 'Edit Data IKU/IKT - Admin Prodi')
@section('page_title', 'Edit Data IKU/IKT')
@section('page_subtitle', 'Perbarui detail data indikator kinerja utama')

@section('content')
<div class="card" style="max-width: 600px; margin: 0 auto;">
    <h3 style="font-size: 1.2rem; font-weight: 700; margin-bottom: 20px; border-bottom: 1px solid #1e293b; padding-bottom: 12px;">Form Edit Data IKU/IKT</h3>
    ...
    <form action="{{ route('adminprodi.iku.update', $iku->id) }}" method="POST" class="form-layout-container">
        ...
        <div class="form-group-custom">
            ...
            <input type="text" 
                   id="kode_iku" 
                   name="kode_iku" 
                   value="{{ old('kode_iku', $iku->kode_iku) }}" 
        ...
        <div class="form-footer-actions">
            ...
            <button type="submit" class="btn btn-primary">Perbarui IKU/IKT</button>
        </div>
    </form>
</div>
@endsection
