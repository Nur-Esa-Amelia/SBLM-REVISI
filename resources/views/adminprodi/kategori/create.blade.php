...
<div class="card" style="max-width: 600px; margin: 0 auto;">
    <h3 style="font-size: 1.2rem; font-weight: 700; margin-bottom: 20px; border-bottom: 1px solid #1e293b; padding-bottom: 12px;">Form Tambah Kategori</h3>

    <form action="{{ route('adminprodi.kategori.store') }}" method="POST" class="form-layout-container">
        @csrf
